...
| Package                                                     | Description                                               |
| ----------------------------------------------------------- | --------------------------------------------------------- |
| [`@nativewindow/webview`](./packages/native-window)         | Rust napi-rs addon providing native window + webview APIs |
| [`@nativewindow/ipc`](./packages/native-window-ipc)         | Pure TypeScript typesafe IPC channel layer                |
| [`@nativewindow/react`](./packages/native-window-ipc-react) | React bindings for the typed IPC layer                    |
| [`@nativewindow/tsdb`](./packages/native-window-tsdb)       | TanStack DB collection adapter for native-window IPC      |
